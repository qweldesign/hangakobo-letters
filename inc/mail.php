...
$Referer_check = 1;
$Referer_check_domain = "hangakobo.com";
...
$jumpPage = 0;
$thanksPage = "https://hangakobo.com/thanks.html";
...
<html>
	...
	<body>
		...
		<?php }else{ ?>
			<div id="contact" class="main__container" align="center">
					送信ありがとうございました。
					<br>送信は正常に完了しました。
